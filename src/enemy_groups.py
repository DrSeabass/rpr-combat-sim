...
tough_weenie = [ tough(PHYSICAL, FINESSE), tough(FINESSE, MENTAL), tough(MENTAL, PHYSICAL),
                 weenie(FINESSE, PHYSICAL), weenie(FINESSE, PHYSICAL) ]
...
decent_weenie = [ decent(PHYSICAL, FINESSE), decent(PHYSICAL, FINESSE),
                  decent(PHYSICAL, MENTAL),  decent(PHYSICAL, MENTAL),
                  weenie(PHYSICAL, MENTAL)]
normal_all = [ normal(FINESSE, MENTAL), normal(FINESSE, MENTAL), normal(FINESSE, MENTAL),
               normal(FINESSE, MENTAL), normal(PHYSICAL, FINESSE), normal(PHYSICAL, FINESSE),
               normal(PHYSICAL, FINESSE)]
normal_weenie = [ normal(FINESSE, MENTAL), normal(FINESSE, MENTAL), normal(FINESSE, MENTAL),
                  normal(FINESSE, MENTAL), normal(PHYSICAL, FINESSE),
                  normal(PHYSICAL, FINESSE),
